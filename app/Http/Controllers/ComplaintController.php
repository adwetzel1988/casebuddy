...
class ComplaintController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'detective_name' => 'required|string',
            'detective_phone' => 'required|string',
            'detective_email' => 'required|string',
        ...
        $complaint = Complaint::create([
            ...
            'status' => 'pending',
            'victim_id' => $user->id,
            'offence_date' => $validatedData['offence_date'],
            'detective_name' => $validatedData['detective_name'],
            'detective_phone' => $validatedData['detective_phone'],
            'detective_email' => $validatedData['detective_email'],
        ]);
